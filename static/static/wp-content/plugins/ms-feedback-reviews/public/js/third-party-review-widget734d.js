jQuery(window).on("elementor/frontend/init", (function () {
  ...
  elementorFrontend.hooks.addA
     ction("frontend/element_ready/" + thirdPartyReview, function ($scope) {
  ...
  var html =  '<div id="swiper-modal">';
      ...
      html +=                '<img id="close-swiper-modal" src="{% static 'wp-content/themes/ms-theme/assets/images/popup-close.png' %}">';
